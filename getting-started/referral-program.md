---
description: >-
  FundX Referral Program — mutually-beneficial partnership, between us and
  our customers. Start earning real money right now.
---

# Referral Program

Our Referral Program allows you to earn real money, that can be spent on buying the FundX licenses or even be withdrawn on demand. The earning process is simple: you receive **15% from each purchase** sum of your referral. We can increase % depending on our own view!
...
How does FundX Referral Program work?
{% endembed %}

### **There are 4 simple steps to start earning by inviting your friends to FundX:**

* **Get a link with your code.** Any registered customer of FundX can find its referral code from within the personal account page ([https://accounts.quantower.com](https://accounts.quantower.com/)) \
...
* **Get earnings.** Each time your referral purchase one or multiple FundX licenses — you earn 15% from the payment sum, including any discounts.
...
* To ask for withdrawal or payment in honor of a personal FundX license, please contact FundX Support via live chat on the official website, email info@quantower.com, [telegram chat](https://t.me/quantower).
...
* FundX reserves the right to modify the rules or rewards of this Referral Program at any point by publishing an updated set of program information.
