# How to connect to IC Markets via FundX

To connect FundX platform to IC Markets broker and send trading orders, you need to use cTrader Gateway. If you already have a trading account with IC Markets, then go to the penultimate step in this manual.
...
* Before connecting for the first time through FundX platform, you need to activate your account in the cTrader system. You can do it via IC Markets **cTrader Web-based** platform [https://ct.icmarkets.com/](https://ct.icmarkets.com/)
...
* Now you can place and manage your orders via FundX or cTrader. Good luck!
