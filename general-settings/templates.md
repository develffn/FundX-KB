...
Due to the wide list of features, most panels in FundX platform have a huge list of customization possibilities. The more powerful panel is — the more settings it has. This allows any user to tune each functionality on its own and sometimes this process can take a lot of time to complete.
...
{% hint style="success" %}
You can **share your templates** with other FundX traders by sharing the template files with them. Template files can be found in “FundX -> Settings -> Templates” folder.
{% endhint %}
