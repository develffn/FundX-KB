...
![Open General Setting for adding FundX Telegram Bot](<../.gitbook/assets/image (171).png>)
...
3. Connect to the FundX Alert Bot.
...
![Duplicate trading notiffications to Telegram with FundX Bot ](<../.gitbook/assets/image (169).png>)
